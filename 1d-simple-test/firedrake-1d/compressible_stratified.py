...
r_0_reciprocal = Function(Ro)
#dr_0 = Function(Ro)
r_0_project.interpolate(Expression( "exp(-3.0*x[0])" ))
#dr_0.interpolate(Expression( "-3.0*exp(-3.0*x[0])" ))
r_0_reciprocal.interpolate(Expression( "1/exp(-3.0*x[0])" ))

# Project background stratification
#dFdr_0 = TestFunction(Ro)
#r_0_project = TrialFunction(Ro)

#a_project = r_0_project*dFdr_0*dx
#L_project = r_0*dFdr_0*dx

#project_problem = LinearVariationalProblem( a_project, L_project, r_0_project )
#project_solver = LinearVariationalSolver( project_problem )
...
#dHdu0 = u0/r_0_project
#dHdrho0 = rho0/r_0_project
